...
// OldFname returns the old fname value of the User.
...
func (m *UserMutation) SetSname(s string) {
	m.sname = &s
}

// Sname returns the sname value in the mutation.
func (m *UserMutation) Sname() (r string, exists bool) {
	v := m.sname
	if v == nil {
		return
	}
...
// OldSname returns the old sname value of the User.
// If the User object wasn't provided to the builder, the object is fetched
// from the database.
// An error is returned if the mutation operation is not UpdateOne, or database query fails.
func (m *UserMutation) OldSname(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *UserMutation) ResetSname() {
	m.sname = nil
}
...
// Birthdate returns the birthdate value in the mutation.
...
// OldBirthdate returns the old birthdate value of the User.
// If the User object wasn't provided to the builder, the object is fetched
// from the database.
// An error is returned if the mutation operation is not UpdateOne, or database query fails.
...
// ResetBirthdate reset all changes of the "birthdate" field.
...
func (m *UserMutation) Fields() []string {
	...
	if m.sname != nil {
		fields = append(fields, user.FieldSname)
	}
	if m.email != nil {
...
// OldDescription returns the old description value of the Video.
// If the Video object wasn't provided to the builder, the object is fetched
// from the database.
// An error is returned if the mutation operation is not UpdateOne, or database query fails.
...
func (m *VideoMutation) Timestamp() (r time.Time, exists bool) {
	v := m.timestamp
	if v == nil {
		return
	}
...
// OldTimestamp returns the old timestamp value of the Video.
// If the Video object wasn't provided to the builder, the object is fetched
// from the database.
// An error is returned if the mutation operation is not UpdateOne, or database query fails.
func (m *VideoMutation) OldTimestamp(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *VideoMutation) ResetTimestamp() {
	m.timestamp = nil
}
